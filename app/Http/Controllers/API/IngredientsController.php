...
class IngredientsController extends Controller
{
    ...
    public function storeIngredient(Request $request)
    {
        ...
        if ($file = $image) {
            $fileNameToStore = $imageHandler->imageUpload($image, 'ingredient_', 'uploads/ingredients/');
        }
        $productData = [
            'title' => $name,
        ...
        $productId = Ingredient::store($productData);
        $this->variantInsertion($request, $productId, $branch);
        $response = [
            'message' => Lang::get('lang.ingredient') . ' ' . Lang::get('lang.successfully_added')
        ];
